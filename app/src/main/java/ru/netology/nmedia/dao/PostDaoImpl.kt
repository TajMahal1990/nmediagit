...
//            ${PostColumns.COLUMN_WATCHES} INTEGER NOT NULL DEFAULT 0,
//            ${PostColumns.COLUMN_VIDEOURL} TEXT NOT NULL
//            );
//        """.trimIndent()
//    }
//
...
//            put(PostColumns.COLUMN_VIDEOURL, "no_video")
//        }
...
//                watches = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_WATCHES)),
